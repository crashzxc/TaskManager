...
// Initialize Firebase
var config = {
    apiKey: "AIzaSyBiueePlYHApAZO7uK1jBpxUq9V-OljSas",
    authDomain: "mytaskmanager-62ffa.firebaseapp.com",
    databaseURL: "https://mytaskmanager-62ffa.firebaseio.com",
    storageBucket: "mytaskmanager-62ffa.appspot.com",
    messagingSenderId: "935287859446"
};
...
router.route('/TaskManager/getTask')
    .get(function(req, res) {
        var ref = firebase.database().ref('tasks');

        ref.on('value', function(item) {
                //console.log('child_added', item.val());
                res.json({ message:item.val() });
